...
public final class DialogLoadingBinding implements ViewBinding {
  ...
  private DialogLoadingBinding(@NonNull LinearLayout rootView, @NonNull TextView txtLoading) {
  ...
  public static DialogLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLoadingBinding((LinearLayout) rootView, txtLoading);
    }
